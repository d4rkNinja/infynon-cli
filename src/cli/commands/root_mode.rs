use crate::cli::args::{
    DoctorAction, EagleEyeAction, PkgArgs, PkgCommands, RootArgs, RootCommands,
};
...
pub fn execute_root_mode() -> Result<(), InfynonError> {
    ...
    match args.command {
        ...
        Some(RootCommands::Doctor { action }) => match action {
            DoctorAction::Npm => features::cmd_doctor_npm(),
        },
