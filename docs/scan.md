...
| Flag | Description |
|------|-------------|
| `--output <FORMAT>` | Export report: `markdown`, `pdf`, `both` |
| `--fix [LEVEL]` | Auto-fix vulnerabilities: `critical`, `high`, `medium`, `low`, `informational`, `all` (default: `all`) |
...
# Auto-fix all fixable vulnerabilities
